...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   ...
   <li>
      <a href="{{ route('admin.categories') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-white/[0.03] group {{ request()->routeIs('admin.categories*') ? 'bg-elvo-elevated border-l-4 border-elvo-primary shadow-[0_0_20px_rgba(124,109,240,0.12)]' : '' }}">
         <svg class="w-5 h-5 text-gray-400 transition duration-75 group-hover:text-elvo-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z"/></svg>
          <span class="ms-3 text-sm tracking-wide">Kategori</span>
      </a>
   </li>
   ...
   <li>
    ...
    <li class="pt-4 pb-1">
       <span class="flex items-center gap-2 px-2 text-xs font-semibold text-elvo-amber uppercase tracking-wider"><span class="w-1.5 h-1.5 rounded-full bg-elvo-amber"></span>⚙️ Pengaturan Toko</span>
    </li>
    <li>
       <a href="{{ route('admin.settings') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-white/[0.03] group {{ request()->routeIs('admin.settings') ? 'bg-elvo-elevated border-l-4 border-elvo-amber shadow-[0_0_20px_rgba(251,191,36,0.12)]' : '' }}">
          ...
          <span class="ms-3 text-sm tracking-wide">Pengaturan Toko</span>
          @if(Auth::user()->role !== 'owner')
          <span class="ms-auto text-[8px] text-gray-600">🔒</span>
          @endif
       </a>
    </li>
   ...
   <li>
      <a href="{{ route('admin.owner.dashboard') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-white/[0.03] group {{ request()->routeIs('admin.owner.dashboard') ? 'bg-elvo-elevated border-l-4 border-elvo-amber' : '' }}">
   ...
   <li>
      <a href="{{ route('admin.owner.financial-reports') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-white/[0.03] group {{ request()->routeIs('admin.owner.financial-reports') ? 'bg-elvo-elevated border-l-4 border-elvo-amber' : '' }}">
         <svg class="w-5 h-5 text-yellow-500 transition duration-75 group-hover:text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
          <span class="ms-3 text-sm tracking-wide">Laporan Keuangan</span>
      </a>
   </li>
   <li>
      <a href="{{ route('admin.owner.product-reports') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-white/[0.03] group {{ request()->routeIs('admin.owner.product-reports') ? 'bg-elvo-elevated border-l-4 border-elvo-amber' : '' }}">
         <svg class="w-5 h-5 text-yellow-500 transition duration-75 group-hover:text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
          <span class="ms-3 text-sm tracking-wide">Laporan Produk</span>
      </a>
   </li>
   <li>
      <a href="{{ route('admin.owner.stock-history') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-white/[0.03] group {{ request()->routeIs('admin.owner.stock-history') ? 'bg-elvo-elevated border-l-4 border-elvo-amber' : '' }}">
         <svg class="w-5 h-5 text-yellow-500 transition duration-75 group-hover:text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
          <span class="ms-3 text-sm tracking-wide">Riwayat Stok</span>
      </a>
   </li>
   @endif
