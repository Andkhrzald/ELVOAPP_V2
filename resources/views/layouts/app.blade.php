    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
          ...
          <div class="flex items-center ms-3 relative group">
                ...
                <div class="absolute right-0 top-full mt-2 w-48 py-2 bg-[#252525] border border-white/10 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   ...
   <li>
      <a href="{{ route('admin.dashboard') }}" class="flex items-center p-2 text-Bold rounded-lg hover:bg-gray-800 group {{ request()->routeIs('admin.dashboard') && !request()->routeIs('admin.dashboard.analytics') ? 'bg-gray-800 border-l-4 border-blue-500' : '' }}">
   ...
   <li>
      <a href="{{ route('admin.dashboard.analytics') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-800 group {{ request()->routeIs('admin.dashboard.analytics') ? 'bg-gray-800 border-l-4 border-blue-500' : '' }}">
   ...
   @if(Auth::user()->role === 'owner')
   <li class="pt-4 pb-1">
      <span class="px-2 text-xs font-semibold text-yellow-500 uppercase tracking-wider">🔐 Owner Panel</span>
   </li>
   <li>
      <a href="{{ route('admin.owner.dashboard') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-800 group {{ request()->routeIs('admin.owner.*') ? 'bg-gray-800 border-l-4 border-yellow-500' : '' }}">
         ...
         <span class="ms-3">Owner Dashboard</span>
      </a>
   </li>
   <li>
      <a href="{{ route('admin.owner.manage-admins') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-800 group {{ request()->routeIs('admin.owner.manage-admins*') ? 'bg-gray-800 border-l-4 border-yellow-500' : '' }}">
   ...
   <li>
      <a href="{{ route('admin.owner.audit-log') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-800 group {{ request()->routeIs('admin.owner.audit-log') ? 'bg-gray-800 border-l-4 border-yellow-500' : '' }}">
   ...
   <li class="pt-4 pb-1 mt-4 border-t border-white/10">
      <span class="px-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">Akun</span>
   </li>
   <li>
