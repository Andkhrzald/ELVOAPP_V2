...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-400">Selamat datang kembali, Andikha! Berikut adalah performa Elvoapp hari ini.</p>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    ...
    <div class="p-5 bg-[#1a1a1a] rounded-xl border border-white/5 shadow-sm">
        ...
        <p class="text-2xl font-bold text-white">Rp 42.500.000</p>
    ...
    <div class="p-5 bg-[#1a1a1a] rounded-xl border border-white/5 shadow-sm">
        ...
        <p class="text-2xl font-bold text-white">1,205</p>
    ...
    <div class="p-6 bg-[#1a1a1a] rounded-xl border border-white/5 shadow-sm">
        ...
        <div class="space-y-4">
            <div class="flex gap-3">
                ...
                <div>
                    <p class="text-sm text-gray-200">Pesanan baru <span class="font-bold text-white">#TRX-99</span></p>
            ...
            <div class="flex gap-3">
                ...
                <div>
                    <p class="text-sm text-gray-200">Stok MacBook Pro diperbarui</p>
            ...
            <div class="flex gap-3">
                ...
                <div>
                    <p class="text-sm text-gray-200">Pembayaran diproses Siti</p>
                    <p class="text-xs text-gray-500">3 jam yang lalu</p>
                </div>
            </div>
        </div>
        <button class="w-full mt-6 py-2 text-sm font-semibold text-blue-400 bg-blue-500/10 rounded-lg hover:bg-blue-500 hover:text-white transition">
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            scales: {
                y: {
                    beginAtZero: true,
                    grid: { color: 'rgba(255, 255, 255, 0.05)' }, // Grid tipis gelap
                    ticks: { color: '#6b7280' } // Warna angka y-axis
                },
                x: {
                    grid: { display: false },
                    ticks: { color: '#6b7280' } // Warna teks x-axis
                }
            }
        }
    });
