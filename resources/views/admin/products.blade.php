...
<div id="modal-tambah" class="fixed inset-0 z-[100] hidden items-center justify-center bg-black/80 backdrop-blur-md">
    <div class="relative p-8 w-full max-w-3xl max-h-[90vh] overflow-y-auto bg-elvo-surface rounded-[2rem] shadow-2xl border border-white/10 animate-modal-in">
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" id="productName" onkeyup="generateSlug(this.value)" class="w-full bg-elvo-bg border border-white/[0.06] rounded-2xl px-5 py-4 text-white focus:border-elvo-primary outline-none transition-all placeholder-gray-700" placeholder="Contoh: Premium Elvo Hoodie Black Edition" required>
                </div>

                <div class="md:col-span-2">
                    <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3">Slug URL (Otomatis)</label>
                    <div class="flex items-center gap-2 bg-[#0a0a0a] border border-white/[0.06] rounded-2xl px-5 py-3 text-[10px] text-gray-500 font-mono">
                        <span>elvo.com/shop/</span>
                        <input type="text" name="slug" id="productSlug" class="bg-transparent border-none p-0 focus:ring-0 text-[#8b7df2] font-bold w-full" readonly>
                    </div>
                </div>

                <div>
                    <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3">Kategori</label>
                    <select name="category_id" class="w-full bg-elvo-bg border border-white/[0.06] rounded-2xl px-5 py-4 text-white focus:border-elvo-primary outline-none transition-all" required>
                ...
                <div>
                    ...
                    <input type="text" name="color" class="w-full bg-elvo-bg border border-white/[0.06] rounded-2xl px-5 py-4 text-white focus:border-elvo-primary outline-none transition-all" placeholder="Hitam / Putih">
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price" class="w-full bg-elvo-bg border border-white/[0.06] rounded-2xl pl-12 pr-5 py-4 text-white focus:border-elvo-primary outline-none transition-all font-black text-xl" placeholder="0" required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="stock" class="w-full bg-elvo-bg border border-white/[0.06] rounded-2xl px-5 py-4 text-white focus:border-elvo-primary outline-none transition-all" required>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3">Berat (g)</label>
                        <input type="number" name="weight" class="w-full bg-elvo-bg border border-white/[0.06] rounded-2xl px-5 py-4 text-white focus:border-elvo-primary outline-none transition-all" required>
                    </div>
                </div>

                <div class="md:col-span-2">
                    <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3">Deskripsi Produk</label>
                    <textarea name="description" rows="4" class="w-full bg-elvo-bg border border-white/[0.06] rounded-2xl px-5 py-4 text-white focus:border-elvo-primary outline-none transition-all resize-none" placeholder="Jelaskan detail produk, bahan, dan keunggulannya..." required></textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <label class="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-white/[0.06] rounded-3xl cursor-pointer hover:bg-white/[0.02] hover:border-elvo-primary/50 transition-all group">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            <svg class="w-10 h-10 mb-3 text-gray-500 group-hover:text-elvo-primary transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M12 4v16m8-8H4" stroke-width="2" stroke-linecap="round"/></svg>
                ...
                <div class="md:col-span-2 flex items-center gap-3">
                    <input type="checkbox" name="is_active" value="1" checked id="isActiveCheck" class="w-5 h-5 bg-elvo-bg border-white/10 rounded text-elvo-primary focus:ring-elvo-primary">
                    <label for="isActiveCheck" class="text-sm font-bold text-gray-300 cursor-pointer">Langsung tampilkan di website (Aktif)</label>
                </div>
            </div>

            <div class="flex justify-end gap-4 pt-8 border-t border-white/[0.06]">
                ...
                <button type="submit" class="px-10 py-4 btn-primary text-xs font-black uppercase tracking-widest rounded-2xl shadow-xl">Simpan Produk</button>
            </div>
        </form>
    </div>
</div>
