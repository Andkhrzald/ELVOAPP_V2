...
<div class="min-h-screen bg-[#0f0f0f] text-gray-300 pb-12">
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row md:items-end justify-between mb-8 px-4 lg:px-0 pt-10 gap-4">
        ...
        <div class="flex gap-3">
            <button class="bg-elvo-surface border border-white/[0.06] text-gray-300 px-5 py-2.5 rounded-xl text-xs font-bold hover:bg-white/10 hover:text-white transition-all flex items-center gap-2 shadow-xl">
